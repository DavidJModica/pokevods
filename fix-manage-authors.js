...
// The Manage Authors tab content to insert
const manageAuthorsTabContent = `
          {/* Manage Authors Tab */}
...
// Insert the tab content right before the closing </div> of the admin panel
// Find the line that has "        </div>" after the Manage Guides tab closes
content = content.replace(
  /(}\s*)\n(\s*<\/div>\s*\n\s*{\/\* Edit Resource Modal)/,
  `$1\n${manageAuthorsTabContent}\n$2`
);

fs.writeFileSync('src/App.js', content);
console.log('Successfully added Manage Authors tab content!');
